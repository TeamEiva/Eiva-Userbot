...
async def start(event):
    ...
    vent = event.chat_id
    pic = Config.ALIVE_PIC or "https://telegra.ph/file/01acbca0956904a6102fb.jpg"
    starttext = f"Hello, {firstname} ! Nice To Meet You, Well I Am {bot_id}, An Powerfull Assistant Bot. \n\nMy [➤ Master](tg://user?id={bot.uid}) \nYou Can Talk/Contact My Master Using This Bot.(Coming Soon) \n\nIf You Want Your Own Assistant You Can Deploy From Button Below. \n\nPowered By [Team Eiva](https://t.me/TheEiva)"
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("Deploy your EivaBot", "https://github.com/TeamEiva/Eiva-Userbot")],
                [Button.url("Help Me ❓", "https://t.me/EivaSupport")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            event.chat_id,
            message="You Can Deploy Eiva In Heroku By Following Steps Bellow, You Can See Some Quick Guides On Support Channel Or On Your Own Assistant Bot. \nThank You For Contacting Me.",
            buttons=[
                [
                    Button.url(
                        "Deploy",
                        "https://github.com/TeamEiva/Eiva-Userbot",
                    )
                ],
                [Button.url("Need Help ❓", "https://t.me/EivaSupport")],
            ],
        )
