...
from Eivabot.sql.welcome_sql import get_current_welcome, add_welcome, rm_welcome, update_welcome
from . import *
...
@bot.on(Eiva_cmd(pattern="savewelcome(?: |$)(.*)"))
...
@bot.on(Eiva_cmd(pattern="cleanwelcome$"))
...
@bot.on(Eiva_cmd(pattern="showwelcome$"))
...
@bot.on(Eiva_cmd(pattern="welcome_note$"))
