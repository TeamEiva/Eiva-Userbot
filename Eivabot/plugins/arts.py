...
@bot.on(Eiva_cmd(pattern="sthink (.*)"))
...
@bot.on(Eiva_cmd(pattern="strump (.*)"))
...
@bot.on(Eiva_cmd(pattern="schina (.*)"))
...
@bot.on(Eiva_cmd(pattern=r"sshit$"))
...
@bot.on(Eiva_cmd(pattern=r"elove$"))
...
@bot.on(Eiva_cmd(pattern=r"monster$"))
...
@bot.on(Eiva_cmd(pattern=r"Eivao$"))
@bot.on(sudo_cmd(pattern="Eivao$", allow_sudo=True))
async def bluedevilEivao(Eivao):
    if Eivao.fwd_from:
        return
    await edit_or_reply(Eivao, K)


@bot.on(Eiva_cmd(pattern=r"hmf$"))
...
@bot.on(Eiva_cmd(pattern=r"couple$"))
...
@bot.on(Eiva_cmd(pattern=r"india$"))
...
@bot.on(Eiva_cmd(pattern=r"shitos$"))
...
@bot.on(Eiva_cmd(pattern=r"dislike$"))
