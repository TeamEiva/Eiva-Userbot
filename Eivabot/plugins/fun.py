...
@bot.on(Eiva_cmd(pattern="slap ?(.*)", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"habuse$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"fuk$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"chu$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"noob$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"run$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"gali$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"rape$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"abuse$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"gey$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"piro$", outgoing=True))
