...
@bot.on(Eiva_cmd(pattern="offline$", outgoing=True)) 
async def _(event):
    if event.fwd_from:
        return
    user_it = "me"
...
@bot.on(Eiva_cmd(pattern="online$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    user_it = "me"
...
@bot.on(Eiva_cmd(outgoing=True, pattern="username (.*)"))
...
@bot.on(Eiva_cmd(outgoing=True, pattern="count$"))
...
@bot.on(Eiva_cmd(outgoing=True, pattern=r"delpfp"))
...
@bot.on(Eiva_cmd(pattern="myusernames$"))
async def _(event):
    if event.fwd_from:
        return
...
CmdHelp("profile").add_command(
  ...
  "pbio", "<text>", "Changes your Telegram bio", ".pbio Eivao there, This iz my bio"
).add_command(
