...
@bot.on(Eiva_cmd(pattern="frybot$"))
...
@bot.on(Eiva_cmd(pattern=r"fry(?: |$)(.*)", outgoing=True))
...
async def deepfry(img: Image) -> Image:
    ...
    # Overlay red and yellow onto main image and sharpen the Eiva out of it
