...
from . import *
from Eivabot.sql import pmpermit_sql as pm_sql


WARN_PIC = Config.PMPERMIT_PIC or "https://telegra.ph/file/5501c52fed1b2229ad03d.jpg"
PM_WARNS = {}
PREV_REPLY_MESSAGE = {}
...
Eiva_FIRST = (
    "**🔥 Σιναвσт ρяιναтє sє¢υяιтy ρяσтσ¢σl 🔥**\n\nThis is to inform you that "
...
if PM_ON_OFF != "DISABLE":
    ...
    @bot.on(Eiva_cmd(pattern="(da|disapprove|disallow)$"))
    ...
    @bot.on(Eiva_cmd(pattern="listapproved$"))
    async def approve_p_m(event):
        if event.fwd_from:
            return
