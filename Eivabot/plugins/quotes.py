...
@bot.on(Eiva_cmd(pattern=f"love$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"dhoka$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"metoo$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"gdnoon$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"chase$", outgoing=True))
@bot.on(sudo_cmd(pattern=f"chase$", allow_sudo=True))
async def police(e):
    txt = random.choice(CHASE_STR)
    await eor(e, txt)

@bot.on(Eiva_cmd(pattern=f"congo$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"qhi$", outgoing=True))
@bot.on(sudo_cmd(pattern=f"qhi$", allow_sudo=True))
async def hoi(e):
    txt = random.choice(EivaOSTR)
    await eor(e, txt)

@bot.on(Eiva_cmd(pattern=f"gdbye$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"gdnyt$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"gdmng$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern="quote ?(.*)", outgoing=True))
...
async def quote_search(event):
    ...
    if response is not None:
        await Eiva.edit(f"`{response['text']}`")
    else:
        await eod(Eiva, "`Sorry Zero results found`")
...
CmdHelp("quotes").add_command(
  ...
  "qhi", None, "Sends a random Eivao msg"
).add_command(
