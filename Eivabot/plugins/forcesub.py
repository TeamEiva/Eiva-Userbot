...
from Eivabot.sql.fsub_sql import *
from . import *
"""
...
@bot.on(Eiva_cmd(pattern="rmfsub"))
...
@bot.on(Eiva_cmd(pattern="chfsub"))
...
@bot.on(Eiva_cmd(pattern="lsfsub$"))
