...
from . import *
from Eivabot.sql.filter_sql import get_filter, add_filter, remove_filter, get_all_filters, remove_all_filters
...
@bot.on(Eiva_cmd(pattern=r"filter (.*)"))
...
@bot.on(Eiva_cmd(pattern="filters$"))
...
@bot.on(Eiva_cmd(pattern="rmallfilters$"))
