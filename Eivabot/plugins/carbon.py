...
@bot.on(Eiva_cmd(outgoing=True, pattern="carbon(?: |$)(.*)"))
...
async def carbon_api(e):
    ...
    Eiva = await edit_or_reply(e, "`Carbonizing...\n25%`")
    ...
    await Eiva.edit("`Processing..\n75%`")
    # Waiting for downloading
    await asyncio.sleep(2)
    await Eiva.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await Eiva.edit("`Uploading..`")
...
@bot.on(Eiva_cmd(outgoing=True, pattern="krb"))
@bot.on(sudo_cmd(pattern="krb", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
    Eiva = await edit_or_reply(e, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await e.get_reply_message()
    pcode = e.text
    if pcode[5:]:
...
@bot.on(Eiva_cmd(pattern=f"kar1(?: |$)(.*)", outgoing=True))
@bot.on(sudo_cmd(pattern="kar1(?: |$)(.*)", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
    """ A Wrapper for carbon.now.sh """
    Eiva = await edit_or_reply(e, "🔲🔲🔲🔲🔲")
    ...
    await Eiva.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await Eiva.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
    ...
    os.remove("./carbon.png")
    # Removing carbon.png after uploading
    await Eiva.delete()  # Deleting msg


@bot.on(Eiva_cmd(pattern=f"kar2(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await Eiva.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await Eiva.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(Eiva_cmd(pattern=f"kar3(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await Eiva.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await Eiva.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(Eiva_cmd(pattern=f"kar4(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await Eiva.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await Eiva.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(Eiva_cmd(pattern=f"rgbk2(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await Eiva.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await Eiva.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(Eiva_cmd(pattern=f"kargb(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await Eiva.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await Eiva.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your karbonrgb",
