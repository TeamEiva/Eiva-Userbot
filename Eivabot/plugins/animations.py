...
@bot.on(Eiva_cmd(pattern=r"boxs$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=r"rain$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=r"deploy$", outgoing=True))
...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](The-EivaBot/EivaBot)**",
        f"**Build started by user** {Eiva_mention}",
        f"**Deploy** `535a74f0` **by user** **{Eiva_mention}**",
        ...
        "__INFO:EIVABOT:Logged in as 557667062__",
        "__INFO:EIVABOT:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
@bot.on(Eiva_cmd(pattern=r"dump$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=r"fleaveme$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=r"loveu$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=r"plane$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=r"police$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"wahack$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=r"jio$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=r"solarsystem$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"nehi$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern="phub$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=r"amore$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=r"sexy$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern="istar$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=r"lmoon", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=r"city", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=r"hii", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=r"cheer", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=r"getwell", outgoing=True))
...
@bot.on(Eiva_cmd(pattern="switch$", outgoing=True))
...
async def _(event):
  ...
  #  if input_str == "switch":
    ...
    animation_chars = [
         "⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜[🔲](https://github.com/The-EivaBot/EivaBot)\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜",
         "⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜[🔲](https://github.com/The-EivaBot/EivaBot)\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n[👉](https://t.me/Ryoishin)⬜⬜⬜⬜⬜⬜",
         "⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜[🔲](https://github.com/The-EivaBot/EivaBot)\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬛[👉](https://t.me/Ryoishin)⬜⬜⬜⬜⬜",
         "⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜[🔲](https://github.com/The-EivaBot/EivaBot)\n⬜⬜⬜⬜⬜⬜⬜\n⬜[👆](https://t.me/Ryoishin)⬜⬜⬜⬜⬜\n⬛⬛⬜⬜⬜⬜⬜",
         "⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜[🔲](https://github.com/The-EivaBot/EivaBot)\n⬜[👆](https://t.me/Ryoishin)⬜⬜⬜⬜⬜\n⬜⬛⬜⬜⬜⬜⬜\n⬛⬛⬜⬜⬜⬜⬜",
...
@bot.on(Eiva_cmd(pattern=r"sprinkle", outgoing=True))
...
@bot.on(Eiva_cmd(outgoing=True, pattern="kiler( (.*)|$)"))
...
async def _(event):
    ...
    event = await eor(event, f"**Ready Commando **__{Eiva_mention}....")
    animation_chars = [
        "Ｆｉｉｉｉｉｒｅ",
        f"__**Commando **__{Eiva_mention}          \n\n_/﹋\_\n (҂`_´)\n <,︻╦╤─ ҉ - \n _/﹋\_\n",
        f"__**Commando **__{Eiva_mention}          \n\n_/﹋\_\n (҂`_´)\n  <,︻╦╤─ ҉ - -\n _/﹋\_\n",
        f"__**Commando **__{Eiva_mention}          \n\n_/﹋\_\n (҂`_´)\n <,︻╦╤─ ҉ - - -\n _/﹋\_\n",
        f"__**Commando **__{Eiva_mention}          \n\n_/﹋\_\n (҂`_´)\n<,︻╦╤─ ҉ - -\n _/﹋\_\n",
        f"__**Commando **__{Eiva_mention}          \n\n_/﹋\_\n (҂`_´)\n <,︻╦╤─ ҉ - \n _/﹋\_\n",
...
@bot.on(Eiva_cmd(pattern="thinking$"))
...
@bot.on(Eiva_cmd(pattern=f"snake$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"human$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"mc$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=r"repe$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"nikal$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"music$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=f"squ$", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=r"padmin ?(.*)", outgoing=True))
...
@bot.on(Eiva_cmd(pattern=r"hack$", outgoing=True))
...
async def _(event):
    ...
    animation_chars = [
        ...
        f"`Target Selected By Hacker:` {Eiva_mention}",
        ...
        "`Hacking... 100%\n█████████HACKED███████████ `\n\n\n  TERMINAL:\nDownloading Bruteforce-Telegram-0.1.tar.gz (9.3 kB)\nCollecting Data Package\n  Downloading Telegram-Data-Sniffer-7.1.1-py2.py3-none-any.whl (82 kB)\nBuilding wheel for Tg-Bruteforcing (setup.py): finished with status 'done'\nCreated wheel for telegram: filename=Telegram-Data-Sniffer-0.0.1-py3-none-any.whl size=1306 sha256=cb224caad7fe01a6649188c62303cd4697c1869fa12d280570bb6ac6a88e6b7e\n  Stored in directory: /app/.cache/pip/wheels/a2/9f/b5/650dd4d533f0a17ca30cc11120b176643d27e0e1f5c9876b5b\n\n **Successfully Hacked Telegram Server Database**\n\n\n🔹Output: Generating.....",
        f"`Targeted Account Hacked...\n\nPay 999$ To` {Eiva_mention} `To Remove This Hack`\n\n\n  TERMINAL:\nDownloading Bruteforce-Telegram-0.1.tar.gz (9.3 kB)\nCollecting Data Package\n  Downloading Telegram-Data-Sniffer-7.1.1-py2.py3-none-any.whl (82 kB)\nBuilding wheel for Tg-Bruteforcing (setup.py): finished with status 'done'\nCreated wheel for telegram: filename=Telegram-Data-Sniffer-0.0.1-py3-none-any.whl size=1306 sha256=cb224caad7fe01a6649188c62303cd4697c1869fa12d280570bb6ac6a88e6b7e\n  Stored in directory: /app/.cache/pip/wheels/a2/9f/b5/650dd4d533f0a17ca30cc11120b176643d27e0e1f5c9876b5b\n\n **Successfully Hacked Telegram Server Database**\n\n\n🔹**Output:** Successful",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await event.edit(animation_chars[i % 12])
