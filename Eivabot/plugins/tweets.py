...
@bot.on(Eiva_cmd(pattern=r"tweet(?: |$)(.*)"))
...
async def nope(kraken):
    ...
    if not Eiva:
        if kraken.is_reply:
            ...
            return
    tweeter = await bot.inline_query("TwitterStatusBot", f"{(deEmojify(Eiva))}")
...
@bot.on(Eiva_cmd(pattern=r"trump(?: |$)(.*)"))
...
@bot.on(Eiva_cmd(pattern=r"modi(?: |$)(.*)"))
...
@bot.on(Eiva_cmd(pattern=r"dani(?: |$)(.*)"))
...
@bot.on(Eiva_cmd(pattern=r"pappu(?: |$)(.*)"))
...
@bot.on(Eiva_cmd(pattern=r"sunny(?: |$)(.*)"))
...
@bot.on(Eiva_cmd(pattern=r"johhny(?: |$)(.*)"))
...
@bot.on(Eiva_cmd(pattern=r"gandhi(?: |$)(.*)"))
...
@bot.on(Eiva_cmd(pattern=r"kanna(?: |$)(.*)"))
